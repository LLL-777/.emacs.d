...
(custom-set-variables
 '(package-selected-packages
   '(aggressive-indent cargo cmake-mode codex-ide company-box
     dired-sidebar dired-subtree eglot-jl eldoc-box embark-consult
     exec-path-from-shell julia-mode julia-repl mistty nerd-icons-dired
     nyan-mode orderless org-fragtog org-modern project-treemacs rust-mode
     sly solarized-theme treemacs-icons-dired treemacs-magit
